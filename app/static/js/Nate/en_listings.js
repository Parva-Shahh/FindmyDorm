...
document.addEventListener('DOMContentLoaded', function () {
  ...
  dormItems.forEach(function(item,i){
    ...
    wrapper.addEventListener('mouseenter',function(){wrapper.querySelector('.en-card').style.borderColor='#0d6efd';});
    wrapper.addEventListener('mouseleave',function(){wrapper.querySelector('.en-card').style.borderColor='';});
